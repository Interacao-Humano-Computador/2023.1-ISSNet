# Verificação Ponto de Controle 1 Bilheteria Digital
...
<span id="check1ref1">[1] Tópico executado da entrega 5 está com header incorreto (## em vez ###)</span>
...
#### Conclusão
Não foi incluído duas ferramentas que foram utilizadas para entrevistas, o Google Meet e o Discord
#### Sugestões e Melhorias
Incluir as ferramentas Google Meet e Discord referenciando corretamente, com descrição.
...
*Tabela 4: Checklist dos Sites Avaliados.*

</center>

|   Item  |      Descrição      |              Avaliação              |             Observação          |     Referência    |
|:------: |---------------------|:-----------------------------------:|---------------------------------|:-----------------:|
|    1    | É apresentado o método utilizado para a avaliação dos sites?    |✔️FEITO|             | Simone, 2010, Cap. 10| 
|    2    | É explicado brevemente cada site, seus pontos positivos e negativos?       |✔️FEITO|             |                   | 
|    3    | É apresentado as avaliações de cada site?       |✔️FEITO|             |                   | 
|    4    | As avaliações heurísticas seguem as heurísticas de Nielsen? (visibilidade do estado do sistema, correspondência com o mundo real, controle e liberdade do usuário, consistência e padronização, reconhecimento em vez de memorização, flexibilidade e eficiência de uso, projeto estético e minimalista, prevenção de erros, reconhecimento e recuperação de erros, ajuda e documentação)       |✔️FEITO|Algumas avaliações seguiram outros métodos, mas as que seguiram o de Nielsen aplicaram as heurísticas corretamente| Simone , 2010, p.317; ; Nielsen (1993)| 
|    5    | Cada problema encontrado nas avaliações indica local, gravidade, justificativa e recomendações de solução? |✔️FEITO| | Simone, 2010, p.318; Nielsen (1994)|
|    6    | É julgado corretamente a severidade dos problemas, com base na frequência, impacto e persistência? |✔️FEITO| | Simone, 2010, p.319; Nielsen (1994)|
|    7    | A severidade é categorizada segundo a escala de Nielsen (problema cosmético, problema pequeno, problema grande, problema catastrófico)? |✔️FEITO| | Simone, 2010, p.320; Nielsen (1994)|
|    8    | Os relatórios das avaliações apresentam objetivos, escopo da avaliação, descrição da avaliação heurística, diretrizes utilizadas e a lista de problemas encontrados?  |✔️FEITO| | Simone, 2010, p.321|
...
#### Conclusão
Baseado no checklist, não foram encontrados problemas, algumas avaliações usaram outros métodos como inspeção e observação e aplicaram corretamente os conceitos.
#### Sugestões e Melhorias
...
|   Item  |      Descrição      |              Avaliação              |             Observação          |     Referência    |
|:------: |---------------------|:-----------------------------------:|---------------------------------|:-----------------:|
|    1    | É explicado o método utilizado para a avaliação do site?    |✔️FEITO|             | Simone, 2010, Cap. 10| 
...
|    4    | As avaliações heurísticas seguem as heurísticas de Nielsen? (visibilidade do estado do sistema, correspondência com o mundo real, controle e liberdade do usuário, consistência e padronização, reconhecimento em vez de memorização, flexibilidade e eficiência de uso, projeto estético e minimalista, prevenção de erros, reconhecimento e recuperação de erros, ajuda e documentação)       |✔️FEITO| | Simone , 2010, p.317; ; Nielsen (1993)| 
|    5    | Cada problema encontrado nas avaliações indica local, gravidade, justificativa e recomendações de solução? |✔️FEITO| | Simone, 2010, p.318; Nielsen (1994)|
|    6    | É julgado corretamente a severidade dos problemas, com base na frequência, impacto e persistência? |✔️FEITO| | Simone, 2010, p.319; Nielsen (1994)|
|    7    | A severidade é categorizada segundo a escala de Nielsen (problema cosmético, problema pequeno, problema grande, problema catastrófico)? |✔️FEITO| | Simone, 2010, p.320; Nielsen (1994)|
|    8    | Os relatórios das avaliações apresentam objetivos, escopo da avaliação, descrição da avaliação heurística, diretrizes utilizadas e a lista de problemas encontrados? |✔️FEITO| | Simone, 2010, p.321|
