# Verificação Ponto de Controle 1 ISSNet
...
|   Item  |      Descrição      |              Avaliação              |             Observação          |     Referência    |
|:------: |---------------------|:-----------------------------------:|---------------------------------|:-----------------:|
|    1    | É apresentado o método utilizado para a avaliação dos sites?    | ❌NÃO-FEITO  |             | Simone, 2010, Cap. 10| 
|    2    | É explicado brevemente cada site, seus pontos positivos e negativos?       |  ⚠️INCOMPLETO  |Site "Buser" não é explicado|                   | 
|    3    | É apresentado as avaliações de cada site?       |⚠️INCOMPLETO| Avaliação do TST e Buser não são apresentadas<br>Avaliação do Moovit não é apresentada e tem identificação errada no texto<br>Avaliação do ISSNET está identificada como planejamento|                   | 
...
|    5    | Cada problema encontrado nas avaliações indica local, gravidade, justificativa e recomendações de solução? |⚠️INCOMPLETO |A avaliação do SIGAA não contém recomendações de solução| Simone, 2010, p.318; Nielsen (1994)|
...
|    8    | Os relatórios das avaliações apresentam objetivos, escopo da avaliação, descrição da avaliação heurística, diretrizes utilizadas e a lista de problemas encontrados?  |⚠️INCOMPLETO| Avaliação ISSNet não possui documento de Planejamento| Simone, 2010, p.321|
