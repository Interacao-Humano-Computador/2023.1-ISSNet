# Verificação Ponto de Controle 6 ISSNet
...
- Verificação do próprio grupo (grupo 8)
- Verificação do grupo 1

## Checklists

### Artefato Verificação do Grupo 8 (Próprio Grupo)
...
*Tabela 1: Checklist Verificação do Grupo 8.*
...
### Artefato Verificação do Grupo 1
...
*Tabela 2: Checklist Verificação do Grupo 1.*
